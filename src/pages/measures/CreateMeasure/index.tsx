...
interface CreateMeasureFormData {
  client_id: string
  height: number
  weight: number
  neck: number
...
const CreateMeasure: React.FC = () => {
  ...
  const handleSubmit = useCallback(
    async (data: CreateMeasureFormData) => {
      try {
        ...
        addToast({
          type: 'success',
          title: 'Medida cadastrado com sucesso!',
          description: 'A medida foi cadastrado com sucesso!',
        })
      } catch (err) {
        ...
        addToast({
          type: 'error',
          title: 'Erro durante a criação da medida',
          description: 'Ocorreu um erro ao criar a medida, tente novamente',
        })
      }
    },
    [addToast, history, historyState.client_id],
  )
